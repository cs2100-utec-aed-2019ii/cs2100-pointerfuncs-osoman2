...
void * _bubblesort_(void *_array_, void (*_puntero_) (void *, int _i, int _k),int _tam_){
	...
	for (int i = 0; i < _tam_ ; i ++)
		for(int k = 0; k < _tam_-1; k++)
			_puntero_(_array_,k,_k); //la _k es innecesaria
		
		return _array_;
}

/*------FUNCTIONS------*/
//la _k es innecesaria en cada caso
void  _b_int_ (void * _vector_, int _i,int _k){
	if ( ((int*) _vector_)[_i] > ((int*) _vector_)[_i+1])
            {
                int temp1 = ((int*) _vector_)[_i+1];
                ((int*) _vector_)[_i+1]=((int*) _vector_)[_i];
                ((int*) _vector_)[_i]=temp1;
            }       
}
...
void  _b_float_ (void * _vector_, int _i,int _k){
	if ( ((float*) _vector_)[_i] > ((float*) _vector_)[_i+1])
            {
                float temp1 = ((float*) _vector_)[_i+1];
                ((float*) _vector_)[_i+1]=((float*) _vector_)[_i];
                ((float*) _vector_)[_i]=temp1;
            }   
}
...
void  _b_double_ (void * _vector_, int _i,int _k){
	if ( ((double*) _vector_)[_i] > ((double*) _vector_)[_i+1])
            {
                double temp1 = ((double*) _vector_)[_i+1];
                ((double*) _vector_)[_i+1]=((double*) _vector_)[_i];
                ((double*) _vector_)[_i]=temp1;
            }  
}
...
void  _b_char_ (void * _vector_, int _i,int _k){
	if ( ((char*) _vector_)[_i] > ((char*) _vector_)[_i+1])
            {
                char temp1 = ((char*) _vector_)[_i+1];
                ((char*) _vector_)[_i+1]=((char*) _vector_)[_i];
                ((char*) _vector_)[_i]=temp1;
            }  
}
